import { Bell, Bot, GitBranch, Info, Key, ListChecks, Palette, Puzzle, Container, Lock } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'container', labelKey: 'mainTabs.container', icon: Container },
  { id: 'credentials', labelKey: 'mainTabs.credentials', icon: Lock },
